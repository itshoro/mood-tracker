...
const MoodSad = ({ size = "size-8" }: MoodProps) => {
    return (
        <svg
            className={size}
        ...
        >
            ...
            <defs>
                ...
                <radialGradient
                    ...
                    cy="0"
                    r="1"
                    gradientTransform="rotate(135 3.885 8.513) scale(9.10579 4.71285)"
                    gradientUnits="userSpaceOnUse"
                >
                ...
                <radialGradient
                    ...
                    cy="0"
                    r="1"
                    gradientTransform="rotate(135 8.654 10.99) scale(7.66968 4.32966)"
                    gradientUnits="userSpaceOnUse"
                >
                    <stop stopColor="#392108"></stop>
                    <stop offset="1" stopColor="#C87928" stopOpacity="0"></stop>
