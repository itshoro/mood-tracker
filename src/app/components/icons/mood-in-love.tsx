...
const MoodInLove = ({ size = "size-8" }: MoodProps) => {
    return (
        <svg
            className={size}
        ...
        >
            <g clipPath="url(#in-love-a)">
                ...
                <g filter="url(#in-love-l)" opacity="0.5">
                    <path
                        ...
                        strokeLinecap="round"
                        strokeWidth="2"
                        d="M18.5 11.5s.5-2 2.5-2 2.5 2 2.5 2"
                    ></path>
                </g>
                <path
                    stroke="#43273B"
                ...
                <g filter="url(#in-love-m)" opacity="0.26">
                    <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth="0.75"
                        d="M8.25 10.75s.25-2 2.5-2 2.5 2 2.5 2"
                    ></path>
                </g>
                <path
                    stroke="#43273B"
            ...
            <defs>
                ...
                <radialGradient
                    ...
                    cy="0"
                    r="1"
                    gradientTransform="matrix(0 10.5 -6.42871 0 16 12)"
                    gradientUnits="userSpaceOnUse"
                >
                    <stop offset="0.556" stopColor="#584343"></stop>
                    <stop offset="0.74" stopColor="#66525E"></stop>
